CREATE TABLE `apps` (
	...
	`description` text,
	`logo_url` text,
	`created_at` integer DEFAULT '"2025-12-04T09:30:18.375Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-12-04T09:30:18.375Z"' NOT NULL
);
...
CREATE TABLE `page_views` (
	...
	`viewed_at` integer DEFAULT '"2025-12-04T09:30:18.376Z"' NOT NULL,
...
CREATE TABLE `settings` (
	...
	`documentation_name` text DEFAULT 'Documentation' NOT NULL,
	`primary_color` text DEFAULT '#000000',
	`updated_at` integer DEFAULT '"2025-12-04T09:30:18.376Z"' NOT NULL
);
--> statement-breakpoint
CREATE TABLE `users` (
	`id` text PRIMARY KEY NOT NULL,
